...
//      return $title . $this->row_actions( $actions );
    ...
    public function column_default($item, $column_name) {
        switch ($column_name) {
            case 'transactionId':
                _e('<a href="' . site_url() . '/wp-admin/edit.php?post_type=give_when_goals&page=give_when_givers&post=' . $_REQUEST['post'] . '&view=GetTransactionDetail&txn_id=' . $item['transactionId'] . '">' . $item['transactionId'] . '</a>',ITG_TEXT_DOMAIN);
                break;
    ...
    public function extra_tablenav($which) {
        ...
        if ($which == "top") {
            ...
            <div class="alignleft actions bulkactions">
                <a style="margin-right: 5px;margin-bottom: 5px;" class="btn btn-info btn-sm pull-left" href="<?php echo admin_url('edit.php?post_type=give_when_goals'); ?>"><?php _e('Back to Goals',ITG_TEXT_DOMAIN); ?></a>
                <a style="margin-right: 5px;margin-bottom: 5px;" class="btn btn-info btn-sm pull-left" href="<?php echo admin_url('edit.php?post_type=give_when_goals&page=give_when_givers&post='.$_REQUEST['post'].'&view=givers'); ?>"><?php _e('Back to Givers',ITG_TEXT_DOMAIN); ?></a>
